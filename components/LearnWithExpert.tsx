    ...
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex overflow-x-auto pb-2 mb-10 scrollbar-hide">
          <div className="flex space-x-1 mx-auto bg-gray-100 p-1 rounded-xl">
          ...
          {filteredContent.map((item, index) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <button className="mt-4 w-full flex items-center justify-center text-amber-500 hover:text-amber-600 font-medium text-sm border border-amber-200 rounded-lg py-2 hover:bg-amber-50 transition-colors">
