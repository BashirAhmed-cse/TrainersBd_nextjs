      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <button 
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white p-3 rounded-full shadow-md hover:bg-amber-50 transition-colors"
          >
          ...
          <button 
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white p-3 rounded-full shadow-md hover:bg-amber-50 transition-colors"
          >
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 md:p-10 max-w-4xl mx-auto">
                  <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="flex-shrink-0">
                      <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-amber-100">
                        <Image
          ...
          <div className="flex justify-center mt-8 gap-2">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all ${index === currentIndex ? 'bg-amber-500 w-6' : 'bg-gray-300'}`}
